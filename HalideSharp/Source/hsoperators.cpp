...
#define ALL_OPERATORS_TYPE2(CSTYPE1, CPPTYPE1, DEREF1) \
    ...
    ALL_OPERATORS_FOR_TYPES(CSTYPE1, CPPTYPE1, DEREF1, RDom, RDom*, DEREF_POINTER) \
...
#define ALL_OPERATORS() \
    ...
    ALL_OPERATORS_TYPE2(RDom, RDom*, DEREF_POINTER) \
    ALL_OPERATORS_TYPE2(Int, int32_t, DEREF_NOPOINTER) \
    ALL_OPERATORS_TYPE2(Float, float, DEREF_NOPOINTER)

ALL_OPERATORS()

// mod is not defined for floats, so can't be generated by the above. We just
// enumerate all the types that mod is valid for here.
OPERATOR(Var, Var*, DEREF_POINTER, Mod, MOD, Var, Var*, DEREF_POINTER)
OPERATOR(Var, Var*, DEREF_POINTER, Mod, MOD, Expr, Expr*, DEREF_POINTER)
OPERATOR(Var, Var*, DEREF_POINTER, Mod, MOD, RDom, RDom*, DEREF_POINTER)
OPERATOR(Var, Var*, DEREF_POINTER, Mod, MOD, Int, int32_t, DEREF_NOPOINTER)
OPERATOR(Expr, Expr*, DEREF_POINTER, Mod, MOD, Var, Var*, DEREF_POINTER)
OPERATOR(Expr, Expr*, DEREF_POINTER, Mod, MOD, Expr, Expr*, DEREF_POINTER)
OPERATOR(Expr, Expr*, DEREF_POINTER, Mod, MOD, RDom, RDom*, DEREF_POINTER)
OPERATOR(Expr, Expr*, DEREF_POINTER, Mod, MOD, Int, int32_t, DEREF_NOPOINTER)
OPERATOR(Int, int32_t, DEREF_NOPOINTER, Mod, MOD, Var, Var*, DEREF_POINTER)
OPERATOR(Int, int32_t, DEREF_NOPOINTER, Mod, MOD, Expr, Expr*, DEREF_POINTER)
OPERATOR(Int, int32_t, DEREF_NOPOINTER, Mod, MOD, RDom, RDom*, DEREF_POINTER)
OPERATOR(Int, int32_t, DEREF_NOPOINTER, Mod, MOD, Int, int32_t, DEREF_NOPOINTER)
